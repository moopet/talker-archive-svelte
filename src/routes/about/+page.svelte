<section>
  ...
  <h2 id="muds">Does this list contain MUDs?</h2>
  ...
  <h2 id="help">How can I help out?</h2>
  <p>
  ...
  <h2 id="self-host">I want to run my own talker. Where do I get started?</h2>
  ...
  <h2 id="spods">How do I get in touch with [spod]?</h2>
